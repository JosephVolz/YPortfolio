...
const about = () => {
  return (
    <>
      <Head>
        <title>Youming Liu | About Page</title>
        <meta
          name="description"
          content="Learn more about Youming Liu, a full stack developer with a passion for  creating innovative solutions. Discover tips for building a developer portfolio and insights on  full-stack development, front-end development, and back-end development."
        />
      </Head>
      <TransitionEffect />
