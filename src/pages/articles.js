...
const articles = () => {
  return (
    <>
      <Head>
        <title>Youming Liu | Articles Page</title>
        <meta
          name="description"
          content="Browse through Youming's collection of software engineering articles and tutorials on Next.js, React.js, web development, and more.  Gain valuable insights and stay up-to-date with SEO tips for building a developer portfolio."
        />
      </Head>
      <TransitionEffect />
